class LibraryLoader {
    ...
    async loadAllLibraries() {
        ...
        // Load KaTeX CSS from local node_modules with CDN fallback (crucial for Tauri Webview context)
        this.loadLocalCSS(
        ...
        const libraries = [
            ...
            {
                name: 'JSZip',
                localUrl: '../../node_modules/jszip/dist/jszip.min.js',
                cdnUrl: 'https://cdn.jsdelivr.net/npm/jszip@3.10.1/dist/jszip.min.js',
